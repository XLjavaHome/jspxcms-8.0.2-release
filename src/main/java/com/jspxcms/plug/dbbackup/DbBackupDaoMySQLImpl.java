...
public class DbBackupDaoMySQLImpl implements DbBackupDao {
    ...
    public List<String> getTables(String schema) {
        ...
        List<String> tables = jdbc.queryForList(sql, new Object[]{schema}, String.class);
        return tables;
    }

    public String getTableDDL(String schema, String table) {
        String sql = "show create table `" + schema + "`.`" + table + "`";
        String ddl = "DROP TABLE IF EXISTS `" + table + "`;" + NEWLINE + jdbc.query(sql, new ResultSetExtractor<String>() {
