...
public class GlobalOther implements Configurable {
    ...
    public static final String BUFFER_INFO_DOWNLOADS = PREFIX + "bufferInfoDownloads";
    ...
    public static final String BUFFER_INFO_COMMENTS = PREFIX + "bufferInfoComments";
    ...
    public void setBufferInfoDownloads(Integer bufferInfoDownloads) {
        if (bufferInfoDownloads != null) {
            getCustoms().put(BUFFER_INFO_DOWNLOADS, bufferInfoDownloads.toString());
        } else {
    ...
    public void setBufferInfoComments(Integer bufferInfoComments) {
        if (bufferInfoComments != null) {
            getCustoms().put(BUFFER_INFO_COMMENTS, bufferInfoComments.toString());
        } else {
