...
public class GlobalRegister implements Configurable {
     ...
     * 注册验证EMAIL标题
     */
    public static final String VERIFY_EMAIL_SUBJECT = PREFIX + "verifyEmailSubject";
    /**
     * 注册验证EMAIL正文
     */
     ...
     * 找回密码EMAIL标题
     */
    public static final String PASSWORD_EMAIL_SUBJECT = PREFIX + "passwordEmailSubject";
    /**
     * 找回密码EMAIL正文
     */
    public static final String PASSWORD_EMAIL_TEXT = PREFIX + "passwordEmailText";
    // /**
    // * 邮箱激活EMAIL标题
    // */
