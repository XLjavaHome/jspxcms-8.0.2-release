...
public class User implements java.io.Serializable {
    ...
    public boolean isCaptchaRequired(int captchaErrors) {
        if (getLoginErrorCount() >= captchaErrors && System.currentTimeMillis() - getLoginErrorDate().getTime() < LOGIN_ERROR_MILLIS) {
            return true;
        } else {
            return false;
        }
    ...
    public String getAvatar() {
        if (getDetail().getWithAvatar()) {
            return getGlobal().getUploadsPublishPoint().getUrlPrefix() + Constants.UPLOADS_USERS + "/" + getId() + "/" + AVATAR;
        } else {
    ...
    public String getAvatarLarge() {
        if (getDetail().getWithAvatar()) {
            return getGlobal().getUploadsPublishPoint().getUrlPrefix() + Constants.UPLOADS_USERS + "/" + getId() + "/" + AVATAR_LARGE;
        } else {
            return getGlobal().getTemplateDisplayPathByCtx() + Constants.TEMPLATE_GLOBAL + "/" + AVATAR_LARGE;
        }
    }
    ...
    public String getAvatarSmall() {
        if (getDetail().getWithAvatar()) {
            return getGlobal().getUploadsPublishPoint().getUrlPrefix() + Constants.UPLOADS_USERS + "/" + getId() + "/" + AVATAR_SMALL;
        } else {
