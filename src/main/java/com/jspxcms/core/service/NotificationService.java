...
public interface NotificationService {
    ...
    public Notification send(String type, Integer key, Integer receiverId, String contentTpl, String sourceName, String sourceUrl, String message, String targetName, String targetUrl, String url, String backendUrl);
