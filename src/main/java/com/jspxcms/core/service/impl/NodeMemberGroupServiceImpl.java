...
public class NodeMemberGroupServiceImpl implements NodeMemberGroupService {
    private NodeMemberGroup findOrCreate(Node node, MemberGroup group, Boolean viewPerm, Boolean contriPerm, Boolean commentPerm) {
    ...
    @Transactional
    public void update(MemberGroup group, Integer[] viewNodeIds, Integer[] contriNodeIds, Integer[] commentNodeIds, Integer siteId) {
