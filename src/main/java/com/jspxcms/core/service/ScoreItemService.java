...
public interface ScoreItemService {
    ...
    public ScoreItem[] save(String[] name, Integer[] score, String[] icon, ScoreGroup group);

    public ScoreItem[] update(Integer[] id, String[] name, Integer[] score, String[] icon, ScoreGroup group);
