...
public interface AttachmentDao extends Repository<Attachment, Integer>, AttachmentDaoPlus {
    public Page<Attachment> findAll(Specification<Attachment> spec, Pageable pageable);

    public List<Attachment> findAll(Specification<Attachment> spec, Limitable limitable);
