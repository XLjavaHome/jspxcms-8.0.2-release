...
public class NodeDaoImpl implements NodeDaoPlus {
    ...
    private void predicate(JPAQuery<Node> query, QNode node, Integer[] siteId, Integer parentId, String treeNumber, Boolean isRealNode, Boolean isHidden, Integer[] p0, Integer[] p1, Integer[] p2, Integer[] p3, Integer[] p4, Integer[] p5, Integer[] p6) {
        query.from(node);
    ...
    public List<Node> findForHtml(Integer siteId, Integer nodeId, String treeNumber, boolean forUpdate, Integer lastId, int maxResult) {
