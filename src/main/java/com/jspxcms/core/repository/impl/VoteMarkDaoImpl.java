...
public class VoteMarkDaoImpl implements VoteMarkDaoPlus {
    public int countMark(String ftype, Integer fid, Integer userId, String ip, String cookie, Date after) {
        ...
        if (userId != null) {
            ...
            throw new IllegalArgumentException("userId or ip or cookie is required.");
        }
        if (after != null) {
