...
public class SpecialDaoImpl implements SpecialDaoPlus {
    ...
    private void predicate(JPAQuery<Special> query, QSpecial special, Integer[] siteId, Integer[] categoryId, Date beginDate, Date endDate, Boolean isWithImage, Boolean isRecommend) {
        query.from(special);
