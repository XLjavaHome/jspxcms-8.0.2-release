...
public interface OperationLogDao extends Repository<OperationLog, Integer>, OperationLogDaoPlus {
    public Page<OperationLog> findAll(Specification<OperationLog> spec, Pageable pageable);

    public List<OperationLog> findAll(Specification<OperationLog> spec, Limitable limitable);
