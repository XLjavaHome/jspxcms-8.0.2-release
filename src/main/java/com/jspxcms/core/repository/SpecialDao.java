 ...
 * @author liufang
 */
public interface SpecialDao extends Repository<Special, Integer>, SpecialDaoPlus {
    public Page<Special> findAll(Specification<Special> spec, Pageable pageable);

    public List<Special> findAll(Specification<Special> spec, Limitable limitable);
