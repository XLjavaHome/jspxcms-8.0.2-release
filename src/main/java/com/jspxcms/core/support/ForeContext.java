...
public abstract class ForeContext {
    ...
    public static void setData(Map<String, Object> data, Site site, User user, MemberGroup group, Collection<MemberGroup> groups, Org org, Collection<Org> orgs, String jsessionid, String url) {
    ...
    public static void setPage(Map<String, Object> data, Integer page, PageUrlResolver pageUrlResolver, Page<?> pagedList) {
        if (page == null || page < 1) {
            page = 1;
        }
    ...
    public static void setEmptyResult(boolean isPage, Environment env, TemplateModel[] loopVars) throws TemplateModelException {
        if (isPage) {
