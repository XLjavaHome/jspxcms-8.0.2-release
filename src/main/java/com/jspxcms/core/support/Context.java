...
public abstract class Context {
    ...
    public static Collection<MemberGroup> getCurrentGroups(ServletRequest request) {
        @SuppressWarnings("unchecked") Collection<MemberGroup> groups = (Collection<MemberGroup>) request.getAttribute(GROUPS_REQUEST_NAME);
        return groups;
    }
    ...
    public static Collection<Org> getCurrentOrgs(ServletRequest request) {
        @SuppressWarnings("unchecked") Collection<Org> orgs = (Collection<Org>) request.getAttribute(ORGS_REQUEST_NAME);
        return orgs;
    }
