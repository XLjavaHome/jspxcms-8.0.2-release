...
public class FInfo {
    ...
    public static Query query(Analyzer analyzer, Integer[] siteIds, Integer[] nodeIds, Integer[] attrIds, Date beginDate, Date endDate, String[] status, Integer[] excludeId, String q, String title, String[] keywords, String description, String text, String[] creators, String[] authors) {
        try {
            ...
            if (beginDate != null || endDate != null) {
                ...
                NumericRangeQuery<Long> qy = NumericRangeQuery.newLongRange(PUBLISH_DATE, min, max, true, true);
                query.add(qy, MUST);
            }
            ...
            if (StringUtils.isNotBlank(q)) {
                ...
                Query qy = MultiFieldQueryParser.parse(LUCENE_36, q, new String[]{TITLE, KEYWORD, DESCRIPTION, TEXT}, new Occur[]{SHOULD, SHOULD, SHOULD, SHOULD}, analyzer);
                query.add(qy, MUST);
            }
            if (StringUtils.isNotBlank(title)) {
            ...
            if (StringUtils.isNotBlank(description)) {
                ...
                QueryParser p = new QueryParser(LUCENE_36, DESCRIPTION, analyzer);
