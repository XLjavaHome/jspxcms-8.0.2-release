...
public class InfoFulltextServiceImpl implements InfoFulltextService {
    public List<Info> list(Integer[] siteIds, Integer[] nodeIds, Integer[] attrIds, Date beginDate, Date endDate, String[] status, Integer[] excludeId, String q, String title, String[] keywords, String description, String text, String[] creators, String[] authors, Integer fragmentSize, Limitable limitable, Sort sort) {
        Query query = FInfo.query(analyzer, siteIds, nodeIds, attrIds, beginDate, endDate, status, excludeId, q, title, keywords, description, text, creators, authors);
        ...
        // 高亮代码
        Query hlQuery = FInfo.query(analyzer, null, null, null, null, null, null, null, q, title, keywords, description, text, null, null);
    ...
    public Page<Info> page(Integer[] siteIds, Integer[] nodeIds, Integer[] attrIds, Date beginDate, Date endDate, String[] status, Integer[] excludeId, String q, String title, String[] keywords, String description, String text, String[] creators, String[] authors, Integer fragmentSize, Pageable pageable, Sort sort) {
        Query query = FInfo.query(analyzer, siteIds, nodeIds, attrIds, beginDate, endDate, status, excludeId, q, title, keywords, description, text, creators, authors);
    ...
    private void highlight(Query query, Integer fragmentSize, Collection<Info> coll) {
        ...
        SimpleHTMLFormatter formatter = new SimpleHTMLFormatter("<em class=\"term\">", "</em>");
    ...
    @Transactional
    public int addDocument(Integer siteId, Node node, TaskService taskService, Integer taskId) {
        ...
        Query query = FInfo.query(analyzer, siteIds, nodeIds, null, null, null, null, null, null, null, null, null, null, null, null);
