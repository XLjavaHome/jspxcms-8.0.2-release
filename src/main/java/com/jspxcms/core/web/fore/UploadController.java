...
public class UploadController extends UploadControllerAbstract {
    ...
    public void uploadImage(Boolean scale, Boolean exact, Integer width, Integer height, Boolean thumbnail, Integer thumbnailWidth, Integer thumbnailHeight, Boolean watermark, HttpServletRequest request, HttpServletResponse response) throws IOException {
        uploadImage(null, scale, exact, width, height, thumbnail, thumbnailWidth, thumbnailHeight, watermark, request, response);
    }

    @RequestMapping(value = Constants.SITE_PREFIX_PATH + "/upload_image", method = RequestMethod.POST)
    public void uploadImage(@PathVariable String siteNumber, Boolean scale, Boolean exact, Integer width, Integer height, Boolean thumbnail, Integer thumbnailWidth, Integer thumbnailHeight, Boolean watermark, HttpServletRequest request, HttpServletResponse response) throws IOException {
        siteResolver.resolveSite(siteNumber);
        Site site = Context.getCurrentSite();
        upload(site, request, response, Uploader.IMAGE, scale, exact, width, height, thumbnail, thumbnailWidth, thumbnailHeight, watermark);
    }
    ...
    public void uploadFlash(@PathVariable String siteNumber, HttpServletRequest request, HttpServletResponse response) throws IOException {
        siteResolver.resolveSite(siteNumber);
        Site site = Context.getCurrentSite();
    ...
    public void uploadFile(@PathVariable String siteNumber, HttpServletRequest request, HttpServletResponse response) throws IOException {
        siteResolver.resolveSite(siteNumber);
        Site site = Context.getCurrentSite();
    ...
    public void uploadVideo(@PathVariable String siteNumber, HttpServletRequest request, HttpServletResponse response) throws IOException {
        siteResolver.resolveSite(siteNumber);
        Site site = Context.getCurrentSite();
    ...
    public void ueditor(@PathVariable String siteNumber, HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public void ueditorCatchImage(String siteNumber, HttpServletRequest request, HttpServletResponse response) throws IOException {
        siteResolver.resolveSite(siteNumber);
        Site site = Context.getCurrentSite();
