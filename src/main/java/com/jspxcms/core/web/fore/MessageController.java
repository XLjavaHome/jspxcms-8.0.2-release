...
public class MessageController {
    ...
    public String message(Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
    ...
    public String messageSendForm(Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Site site = Context.getCurrentSite();
        Map<String, Object> data = modelMap.asMap();
        ForeContext.setData(data, request);
        ForeContext.setPage(data, page);
    ...
    @RequestMapping(value = {"/my/message/send", Constants.SITE_PREFIX_PATH + "/my/message/send"}, method = RequestMethod.POST)
    public String messageSend(String receiverUsername, MessageText messageText, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
     ...
     * 检查接收人
     */
    @RequestMapping(value = {"/my/message/check_receiver", Constants.SITE_PREFIX_PATH + "/my/message/check_receiver"})
    @ResponseBody
    ...
    @RequestMapping(value = {"/my/message/contact/{id}", Constants.SITE_PREFIX_PATH + "/my/message/contact/{id}"})
    public String messageContact(@PathVariable Integer id, Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        User user = Context.getCurrentUser();
        Site site = Context.getCurrentSite();
        Map<String, Object> data = modelMap.asMap();
    ...
    public String messageDelete(Integer[] ids, Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Response resp = new Response(request, response, modelMap);
     ...
     * @return
     */
    @RequestMapping(value = {"/my/message/delete_by_contact", Constants.SITE_PREFIX_PATH + "/my/message/delete_by_contact"})
    public String messageDeleteByContact(Integer[] ids, Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Response resp = new Response(request, response, modelMap);
        if (ArrayUtils.isEmpty(ids)) {
            return resp.badRequest();
        }
    ...
    public String inbox(Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Site site = Context.getCurrentSite();
        Map<String, Object> data = modelMap.asMap();
        ForeContext.setData(data, request);
        ForeContext.setPage(data, page);
    ...
    public String inboxShow(@PathVariable Integer id, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Response resp = new Response(request, response, modelMap);
        Site site = Context.getCurrentSite();
        User user = Context.getCurrentUser();
        Map<String, Object> data = modelMap.asMap();
    ...
    public String inboxDelete(Integer[] ids, Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Response resp = new Response(request, response, modelMap);
        if (ArrayUtils.isEmpty(ids)) {
            return resp.badRequest();
        }
    ...
    public String notification(Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Site site = Context.getCurrentSite();
        Map<String, Object> data = modelMap.asMap();
        ForeContext.setData(data, request);
        ForeContext.setPage(data, page);
    ...
    @RequestMapping(value = {"/my/notification/delete", Constants.SITE_PREFIX_PATH + "/my/notification/delete"})
    public String notificationDelete(Integer[] ids, Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Response resp = new Response(request, response, modelMap);
        if (ArrayUtils.isEmpty(ids)) {
            return resp.badRequest();
        }
