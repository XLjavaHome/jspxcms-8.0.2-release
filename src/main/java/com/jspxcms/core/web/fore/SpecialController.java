...
public class SpecialController {
    ...
    public String special(@PathVariable Integer id, Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        return special(null, id, page, request, response, modelMap);
    }

    @RequestMapping(Constants.SITE_PREFIX_PATH + "/special/{id:[0-9]+}")
    public String special(@PathVariable String siteNumber, @PathVariable Integer id, Integer page, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
    ...
    @RequestMapping(Constants.SITE_PREFIX_PATH + "/special_views/{id:[0-9]+}")
