...
public class NodeF7Controller {
    ...
    public String f7NodeTree(Integer id, Integer excludeChildrenId, Boolean isRealNode, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
    ...
    public String f7NodeTreeInfoPerms(Integer id, Integer excludeChildrenId, Boolean isRealNode, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        List<Node> list = query.findList(siteId, null, isRealNode, null);
        Node bean = null, excludeChildrenBean = null;
        if (id != null) {
    ...
    public String f7NodeTreeNodePerms(Integer id, Integer excludeChildrenId, Boolean isRealNode, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        List<Node> list = query.findList(siteId, null, isRealNode, null);
        Node bean = null, excludeChildrenBean = null;
        if (id != null) {
    ...
    public String f7NodeTreeMulti(Integer[] ids, Boolean isRealNode, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        List<Node> list = query.findList(siteId, null, isRealNode, null);
    ...
    public String f7NodeTreeMultiInfoPerms(Integer[] ids, Boolean isRealNode, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        List<Node> list = query.findList(siteId, null, isRealNode, null);
        List<Node> beans = new ArrayList<Node>();
        if (ids != null) {
    ...
    public String f7NodeTreePerms(Integer[] ids, Boolean isRealNode, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        List<Node> list = query.findList(siteId, null, isRealNode, null);
        List<Node> beans = new ArrayList<Node>();
        if (ids != null) {
