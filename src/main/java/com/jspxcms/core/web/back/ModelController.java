...
public class ModelController {
    ...
    public String list(String queryType, @PageableDefault(sort = {"type", "seq", "id"}, direction = Direction.ASC) Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
    ...
    public String edit(Integer id, String queryType, Integer position, @PageableDefault(sort = {"type", "seq", "id"}, direction = Direction.ASC) Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        Model bean = service.get(id);
    ...
    public String save(Integer oid, Model bean, String queryType, String redirect, HttpServletRequest request, RedirectAttributes ra) {
        Integer siteId = Context.getCurrentSiteId();
        List<String> types = modelTypeHolder.getTypesBySiteId(siteId);
        if (StringUtils.isBlank(queryType)) {
            queryType = types.get(0);
    ...
    public String update(@ModelAttribute("bean") Model bean, String queryType, Integer position, String redirect, HttpServletRequest request, RedirectAttributes ra) {
        Site site = Context.getCurrentSite();
        Backends.validateDataInSite(bean, site.getId());
        List<String> types = modelTypeHolder.getTypesBySiteId(site.getId());
        if (StringUtils.isBlank(queryType)) {
    ...
    public String batchUpdate(Integer[] id, String[] name, String[] number, String queryType, HttpServletRequest request, RedirectAttributes ra) {
        Site site = Context.getCurrentSite();
