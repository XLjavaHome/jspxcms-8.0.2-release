...
public class ImageCropController {
    ...
    public String imgAreaSelect(String src, Integer targetWidth, Integer targetHeight, String targetFrame, String name, org.springframework.ui.Model modelMap) {
    ...
    public String imgCrop(String src, Float scale, Integer left, Integer top, Integer width, Integer height, Integer targetWidth, Integer targetHeight, String name, @RequestParam(defaultValue = "false") boolean watermark, HttpServletRequest request, org.springframework.ui.Model modelMap) throws IOException {
