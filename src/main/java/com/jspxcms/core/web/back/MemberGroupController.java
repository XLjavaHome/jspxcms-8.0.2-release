...
public class MemberGroupController {
    ...
    public String list(@PageableDefault(sort = {"seq", "id"}) Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
    ...
    public String edit(Integer id, Integer position, @PageableDefault(sort = {"seq", "id"}) Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
    ...
    public String save(MemberGroup bean, Integer[] viewNodeIds, Integer[] contriNodeIds, Integer[] commentNodeIds, String redirect, HttpServletRequest request, RedirectAttributes ra) {
    ...
    public String update(@ModelAttribute("bean") MemberGroup bean, Integer[] viewNodeIds, Integer[] contriNodeIds, Integer[] commentNodeIds, Integer position, String redirect, HttpServletRequest request, RedirectAttributes ra) {
        if (viewNodeIds == null) {
