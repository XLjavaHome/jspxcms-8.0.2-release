...
public class NotificationController {
    ...
    public String list(@PageableDefault(sort = "id", direction = Direction.DESC, size = PAGE_SIZE) Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
