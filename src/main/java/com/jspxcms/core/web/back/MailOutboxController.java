...
public class MailOutboxController {
    ...
    public String send(@RequestParam(defaultValue = "false") boolean allReceive, String receiverUsername, Integer[] receiverGroupIds, MailText mailText, String redirect, HttpServletRequest request, RedirectAttributes ra) {
    ...
    public String update(@ModelAttribute("bean") MailOutbox bean, @ModelAttribute("mailText") MailText mailText, Integer position, String redirect, RedirectAttributes ra) {
        service.update(bean);
