...
public class MessageController {
    ...
    public String update(@ModelAttribute("bean") Message bean, @ModelAttribute("messageText") MessageText messageText, Integer position, String redirect, RedirectAttributes ra) {
        service.update(bean);
