...
public class RoleController {
    ...
    public String save(Role bean, Integer[] infoPermIds, Integer[] nodePermIds, String redirect, HttpServletRequest request, RedirectAttributes ra) {
        Integer siteId = Context.getCurrentSiteId();
    ...
    public String update(@ModelAttribute("bean") Role bean, Integer[] infoPermIds, Integer[] nodePermIds, Integer position, String redirect, HttpServletRequest request, RedirectAttributes ra) {
        Site site = Context.getCurrentSite();
        Backends.validateDataInSite(bean, site.getId());
        // 如果拥有所有权限，则清空权限字符串。
        if (bean.getAllPerm()) {
    ...
    public String batchUpdate(Integer[] id, String[] name, Integer[] rank, String[] description, HttpServletRequest request, RedirectAttributes ra) {
        Site site = Context.getCurrentSite();
