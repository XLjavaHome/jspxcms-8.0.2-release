...
public class OrgF7Controller {
    ...
    public String f7OrgTree(Integer id, String treeNumber, @RequestParam(defaultValue = "true") Boolean allowRoot, Integer excludeChildrenId, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
    ...
    public String f7OrgTreeMulti(Integer[] ids, String treeNumber, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        List<Org> list = service.findList(treeNumber);
