...
public abstract class AbstractInfoFulltextListPageDirective {
    ...
    public void doExecute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body, boolean isPage) throws TemplateException, IOException {
        ...
        if (isPage) {
            ...
            Page<Info> pagedList = fulltext.page(siteId, nodeId, null, beginDate, endDate, status, excludeId, q, title, keyword, description, text, creator, author, fragmentSize, pageable, sort);
            ...
            List<Info> list = fulltext.list(siteId, nodeId, null, beginDate, endDate, status, excludeId, q, title, keyword, description, text, creator, author, fragmentSize, limitable, sort);
