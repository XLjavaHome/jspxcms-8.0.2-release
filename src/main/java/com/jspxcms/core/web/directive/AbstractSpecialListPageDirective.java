...
public abstract class AbstractSpecialListPageDirective {
    ...
    public void doExecute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body, boolean isPage) throws TemplateException, IOException {
        ...
        if (isPage) {
            ...
            Page<Special> pagedList = service.findPage(siteId, categoryId, beginDate, endDate, isWithImage, isRecommend, pageable);
            ...
            List<Special> list = service.findList(siteId, categoryId, beginDate, endDate, isWithImage, isRecommend, limitable);
