...
public abstract class AbstractCommentListPageDirective {
    ...
    public void doExecute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body, boolean isPage) throws TemplateException, IOException {
        ...
        if (isPage) {
            ...
            Page<Comment> pagedList = service.findPage(ftype, fid, creatorId, status, siteId, pageable);
            ...
            List<Comment> list = service.findList(ftype, fid, creatorId, status, siteId, limitable);
