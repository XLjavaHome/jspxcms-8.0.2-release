...
public abstract class AbstractInfoListPageDirective {
    ...
    public void doExecute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body, boolean isPage) throws TemplateException, IOException {
        ...
        Integer[] excludeNodeId = Freemarkers.getIntegers(params, EXCLUDE_NODE_ID);
        String[] excludeNode = Freemarkers.getStrings(params, EXCLUDE_NODE);
        String[] excludeNodeNumber = Freemarkers.getStrings(params, EXCLUDE_NODE_NUMBER);
        ...
        boolean isIncludeChildren = Freemarkers.getBoolean(params, IS_INCLUDE_CHILDREN, false);
        boolean isMainNodeOnly = Freemarkers.getBoolean(params, IS_MAIN_NODE_ONLY, false);
        ...
        if (isPage) {
            ...
            Page<Info> pagedList = query.findPage(modelId, nodeId, attrId, specialId, tagId, siteId, mainNodeId, userId, viewGroupId, viewOrgId, treeNumber, specialTitle, tagName, priority, beginDate, endDate, title, includeId, excludeId, excludeMainNodeId, excludeTreeNumber, isWithImage, status, p0, p1, p2, p3, p4, p5, p6, pageable);
            ...
            List<Info> list = query.findList(modelId, nodeId, attrId, specialId, tagId, siteId, mainNodeId, userId, viewGroupId, viewOrgId, treeNumber, specialTitle, tagName, priority, beginDate, endDate, title, includeId, excludeId, excludeMainNodeId, excludeTreeNumber, isWithImage, status, p0, p1, p2, p3, p4, p5, p6, limitable);
