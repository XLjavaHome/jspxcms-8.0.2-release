...
public abstract class AbstractNodeListPageDirective {
    ...
    public void doExecute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body, boolean isPage) throws TemplateException, IOException {
        ...
        if (isPage) {
            ...
            Page<Node> pagedList = service.findPage(siteId, parentId, treeNumber, isRealNode, isHidden, p0, p1, p2, p3, p4, p5, p6, pageable);
            ...
            List<Node> list = service.findList(siteId, parentId, treeNumber, isRealNode, isHidden, p0, p1, p2, p3, p4, p5, p6, limitable);
