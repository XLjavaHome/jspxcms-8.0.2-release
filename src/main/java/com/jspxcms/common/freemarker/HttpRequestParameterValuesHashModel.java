...
public class HttpRequestParameterValuesHashModel implements TemplateHashModelEx {
    ...
    public HttpRequestParameterValuesHashModel(HttpServletRequest request) {
        ...
        this.queryStringMap = Servlets.parseQueryString(request.getQueryString());
    }

    public TemplateModel get(String key) {
        String[] value = Servlets.getParamValues(request, queryStringMap, key);
    ...
    public TemplateCollectionModel values() {
        ...
        return new SimpleCollection(new Iterator<String[]>() {
            ...
            public String[] next() {
                return Servlets.getParamValues(request, queryStringMap, iter.next());
            }
