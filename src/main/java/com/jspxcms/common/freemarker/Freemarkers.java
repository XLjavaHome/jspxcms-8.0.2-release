...
public class Freemarkers {
    ...
    public static final Integer getOffset(Map<String, TemplateModel> params) throws TemplateModelException {
        return getInteger(params, OFFSET);
    }

    public static final Integer getLimit(Map<String, TemplateModel> params) throws TemplateModelException {
        return getInteger(params, LIMIT);
    }

    public static final Sort getSort(Map<String, TemplateModel> params) throws TemplateModelException {
        return getSort(params, null);
    }

    public static final Sort getSort(Map<String, TemplateModel> params, Sort def) throws TemplateModelException {
    ...
    public static final org.apache.lucene.search.Sort getFulltextSort(Map<String, TemplateModel> params) throws TemplateModelException {
        return getFulltextSort(params, null);
    }

    public static final org.apache.lucene.search.Sort getFulltextSort(Map<String, TemplateModel> params, org.apache.lucene.search.Sort def) throws TemplateModelException {
        String s = getString(params, SORT);
        if (StringUtils.isBlank(s)) {
            return def;
        }
        ...
        return new org.apache.lucene.search.Sort(fields.toArray(new SortField[fields.size()]));
    }
    ...
    private static SortField getSortField(String arg) {
        ...
        int len = args.length;
        if (len > 2) {
            field = new SortField(getSortFieldName(args[0]), getSortFieldType(args[1]), getdirectionection(args[2]));
        } else if (len > 1) {
            field = new SortField(getSortFieldName(args[0]), getSortFieldType(args[1]));
        } else {
            throw new IllegalArgumentException("fulltext sort format is 'id int asc' or 'id int': " + arg);
        }
        return field;
    }
    ...
    private static int getSortFieldType(String fieldType) {
        if ("SCORE".equalsIgnoreCase(fieldType)) {
            ...
            throw new IllegalArgumentException("fulltext field type must be 'SCORE, DOC, STRING, INT, FLOAT, LONG, DOUBLE, SHORT, CUSTOM, BYTE, STRING_VAL': " + fieldType);
        }
    }
    ...
    public static final Limitable getLimitable(Map<String, TemplateModel> params, Sort def) throws TemplateModelException {
        Limitable limitable = new LimitRequest(getOffset(params), getLimit(params), getSort(params, def));
        return limitable;
    }

    public static final Limitable getLimitable(Map<String, TemplateModel> params) throws TemplateModelException {
        Limitable limitable = new LimitRequest(getOffset(params), getLimit(params), getSort(params));
        return limitable;
    }

    public static final Limitable getFulltextLimitable(Map<String, TemplateModel> params) throws TemplateModelException {
        Limitable limitable = new LimitRequest(getOffset(params), getLimit(params), null);
        return limitable;
    }

    public static final Integer getPageSize(Map<String, TemplateModel> params) throws TemplateModelException {
    ...
    public static final int getPage(Map<String, TemplateModel> params, Environment env) throws TemplateModelException {
    ...
    public static final Pageable getPageable(Map<String, TemplateModel> params, Environment env) throws TemplateModelException {
        return new PageRequest(getPage(params, env) - 1, getPageSize(params), getSort(params));
    }

    public static final Pageable getPageable(Map<String, TemplateModel> params, Environment env, Sort def) throws TemplateModelException {
        return new PageRequest(getPage(params, env) - 1, getPageSize(params), getSort(params, def));
    }

    public static final Pageable getFulltextPageable(Map<String, TemplateModel> params, Environment env) throws TemplateModelException {
        return new PageRequest(getPage(params, env) - 1, getPageSize(params), null);
    }
    ...
    public static PageUrlResolver getPageUrlResolver(Environment env) throws TemplateModelException {
        ...
        if (model instanceof AdapterTemplateModel) {
            return (PageUrlResolver) ((AdapterTemplateModel) model).getAdaptedObject(PageUrlResolver.class);
        } else {
            return null;
        }
    }

    public static <T> T getParams(TemplateModel model, String name, Class<T> targetClass) throws TemplateModelException {
    ...
    public static <T> T getObject(TemplateModel model, String name, Class<T> targetClass) throws TemplateModelException {
        if (model instanceof AdapterTemplateModel) {
            return (T) ((AdapterTemplateModel) model).getAdaptedObject(targetClass);
        } else {
            throw new TemplateModelException(String.format(NOT_MATCH, name, targetClass.getName()));
        }
    }

    public static <T> T getObject(Map<String, TemplateModel> params, String name, Class<T> targetClass) throws TemplateModelException {
    ...
    public static String getStringRequired(TemplateModel model, String name) throws TemplateModelException {
    ...
    public static String getStringRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
        TemplateModel model = params.get(name);
    ...
    public static String[] getStringsRequired(TemplateModel model, String name) throws TemplateModelException {
        String text = getString(model, name);
    ...
    public static String[] getStringsRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
        TemplateModel model = params.get(name);
    ...
    public static <T extends Number> T getNumber(Map<String, TemplateModel> params, String name, Class<T> targetClass) throws TemplateModelException {
        TemplateModel model = params.get(name);
        return getNumber(model, name, targetClass);
    }

    public static <T extends Number> T getNumberRequired(TemplateModel model, String name, Class<T> targetClass) throws TemplateModelException {
    ...
    public static <T extends Number> T getNumberRequired(Map<String, TemplateModel> params, String name, Class<T> targetClass) throws TemplateModelException {
        TemplateModel model = params.get(name);
    ...
    public static Long getLongRequired(TemplateModel model, String name) throws TemplateModelException {
        return getNumberRequired(model, name, Long.class);
    }

    public static Long getLongRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
    ...
    public static Integer getIntegerRequired(TemplateModel model, String name) throws TemplateModelException {
        return getNumberRequired(model, name, Integer.class);
    }

    public static Integer getIntegerRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
    ...
    public static Integer[] getIntegersRequired(TemplateModel model, String name) throws TemplateModelException {
    ...
    public static Integer[] getIntegersRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
        TemplateModel model = params.get(name);
    ...
    public static Long[] getLongsRequired(TemplateModel model, String name) throws TemplateModelException {
    ...
    public static Long[] getLongsRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
        TemplateModel model = params.get(name);
    ...
    public static Boolean getBooleanRequired(TemplateModel model, String name) throws TemplateModelException {
    ...
    public static Boolean getBooleanRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
        TemplateModel model = params.get(name);
        return getBooleanRequired(model, name);
    }

    public static Date getDate(TemplateModel model, String name, boolean endDate) throws TemplateModelException {
        if (model == null) {
            return null;
    ...
    public static Date getDateRequired(TemplateModel model, String name) throws TemplateModelException {
    ...
    public static Date getDateRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
        TemplateModel model = params.get(name);
        return getDate(model, name);
    }

    public static Date getEndDate(TemplateModel model, String name) throws TemplateModelException {
        return getDate(model, name, true);
    }

    public static Date getEndDate(Map<String, TemplateModel> params, String name) throws TemplateModelException {
        TemplateModel model = params.get(name);
        return getEndDate(model, name);
    }

    public static Date getEndDateRequired(TemplateModel model, String name) throws TemplateModelException {
    ...
    public static Date getEndDateRequired(Map<String, TemplateModel> params, String name) throws TemplateModelException {
        TemplateModel model = params.get(name);
