...
public abstract class Validations {
    ...
    public static boolean range(Integer value, int min, int max, List<String> messages, String name) {
        ...
        if (!isValid) {
            messages.add("parameter '" + name + "' value not between " + min + " and " + max);
        }
        return isValid;
    }
    ...
    public static boolean notEmpty(String value, List<String> messages, String name) {
    ...
    public static boolean maxLength(String value, int maxLength, List<String> messages, String name) {
        ...
        if (!isValid) {
            messages.add("parameter '" + name + "' length no more than " + maxLength);
        }
        return isValid;
    }
    ...
    public static boolean uri(String value, String prefix) {
        return !StringUtils.contains(value, "..") && StringUtils.startsWith(value, prefix);
    }
    ...
    public static boolean email(String value, List<String> messages, String name) {
        ...
        if (!isValid) {
            messages.add("parameter '" + name + "' is not email address: " + value);
        }
        return isValid;
    }
    ...
    public static boolean pattern(String value, String regex, List<String> messages, String name) {
        boolean isValid = pattern(value, regex);
        if (!isValid) {
            messages.add("parameter '" + name + "' is not matches regex: " + value);
        }
        return isValid;
    }
