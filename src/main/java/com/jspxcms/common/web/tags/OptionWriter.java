...
class OptionWriter {
    ...
    public OptionWriter(Object selectedValue, Object optionSource, String valueProperty, String labelProperty) {
    ...
    private boolean isOptionSelected(Object item, Object value) {
        if (seletedValue != null) {
            return seletedValue.equals(item) || seletedValue.equals(value) || (value != null && seletedValue.toString().equals(value.toString()));
        }
        return false;
    }
