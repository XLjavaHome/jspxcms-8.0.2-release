...
public class OptionTag extends AbstractHtmlElementBodyTag {
    ...
    private void renderOption(String body, TagWriter writer) throws JspException {
    ...
    @Override
    protected void renderFromBodyContent(BodyContent bodyContent, TagWriter writer) throws JspException {
