...
public class OptionsTag extends AbstractHtmlElementTag {
    ...
    protected int writeTagContent(TagWriter writer) throws JspException {
        if (items != null) {
            OptionsWriter optionWriter = new OptionsWriter(getSelectedValue(), items, itemValue, itemLabel);
    ...
    private class OptionsWriter extends OptionWriter {
        public OptionsWriter(Object selectedValue, Object optionSource, String valueProperty, String labelProperty) {
