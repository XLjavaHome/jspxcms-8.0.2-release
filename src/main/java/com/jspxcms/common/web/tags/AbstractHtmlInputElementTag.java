...
public abstract class AbstractHtmlInputElementTag extends AbstractHtmlElementTag {
    ...
    protected void writeOptionalAttributes(TagWriter tagWriter) throws JspException {
        ...
        tagWriter.writeOptionalAttributeValue(ONCHANGE_ATTRIBUTE, getOnchange());
        tagWriter.writeOptionalAttributeValue(ACCESSKEY_ATTRIBUTE, getAccesskey());
        tagWriter.writeOptionalAttributeValue(DISABLED_ATTRIBUTE, getDisabled());
        tagWriter.writeOptionalAttributeValue(READONLY_ATTRIBUTE, getReadonly());
    }
