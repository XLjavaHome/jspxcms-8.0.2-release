...
public class Images {
    ...
    public static BufferedImage resize(BufferedImage buff, ScaleParam scaleParam) {
        ...
        if ((scaleHeight == null && scaleWidth >= width) || (scaleWidth == null && scaleHeight >= height) || (scaleHeight != null && scaleWidth != null && scaleHeight >= height && scaleWidth >= width)) {
            return buff;
        }
        if (scaleHeight == null) {
    ...
    public static void watermark(BufferedImage buff, BufferedImage watermark, WatermarkParam watermarkInfo) {
        watermark(buff, watermark, watermarkInfo.getPosition(), watermarkInfo.getPaddingX(), watermarkInfo.getPaddingY(), watermarkInfo.getAlphaFloat(), watermarkInfo.getMinWidth(), watermarkInfo.getMinHeight());
    }
    ...
    public static void watermark(BufferedImage buff, BufferedImage watermark, int postion, int paddingX, int paddingY, float alpha, int minWidth, int minHeight) {
        ...
        if (width < minWidth || height < minHeight || watermarkWidth + paddingX > width || watermarkHeight + paddingY > height) {
            return;
        }
        int x, y;
        switch (postion) {
