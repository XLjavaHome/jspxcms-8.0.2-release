...
public class IndexWriterFactoryBean implements FactoryBean<IndexWriter>, InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        if (directory == null) {
            throw new BeanInitializationException("Must specify a directory property");
        }
        if (indexWriterConfig == null) {
            throw new BeanInitializationException("Must specify a indexWriterConfig property");
        }
    }
