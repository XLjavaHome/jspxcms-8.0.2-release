 ...
 * @author liufang
 */
public class NRTLuceneIndexTemplate implements LuceneIndexTemplate, InitializingBean {
    ...
    public NRTLuceneIndexTemplate(TrackingIndexWriter trackingIndexWriter, NRTManager nrtManager) {
    ...
    public void afterPropertiesSet() throws Exception {
        if (trackingIndexWriter == null) {
            throw new IllegalArgumentException("trackingIndexWriter is required");
        }
        if (nrtManager == null) {
