 ...
 * @author liufang
 */
public class NRTManagerFactoryBean implements FactoryBean<NRTManager>, InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        if (trackingIndexWriter == null) {
            throw new BeanInitializationException("Must specify a trackingIndexWriter property");
        }
    }
