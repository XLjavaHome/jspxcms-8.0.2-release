 ...
 * @author liufang
 */
public class SearcherManagerFactoryBean implements FactoryBean<SearcherManager>, InitializingBean, DisposableBean {
    private SearcherManager searcherManger;
    private IndexWriter indexWriter;

    public SearcherManager getObject() throws Exception {
        if (searcherManger == null) {
            searcherManger = new SearcherManager(indexWriter, true, new SearcherFactory());
        }
    ...
    public void afterPropertiesSet() throws Exception {
        if (indexWriter == null) {
            throw new BeanInitializationException("Must specify a indexWriter property");
        }
    }
