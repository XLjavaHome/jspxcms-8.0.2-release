 ...
 * @author liufang
 */
public class MyManageableImageCaptchaService extends DefaultManageableImageCaptchaService implements MyImageCaptchaService {
    /**
     ...
     */
    public MyManageableImageCaptchaService(int minGuarantedStorageDelayInSeconds, int maxCaptchaStoreSize, int captchaStoreLoadBeforeGarbageCollection) {
