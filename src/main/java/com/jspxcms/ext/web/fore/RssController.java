...
public class RssController {
    ...
    public String center(HttpServletRequest request, org.springframework.ui.Model modelMap) {
        return center(null, request, modelMap);
    }

    @RequestMapping(Constants.SITE_PREFIX_PATH + "/rss_center")
    public String center(@PathVariable String siteNumber, HttpServletRequest request, org.springframework.ui.Model modelMap) {
    ...
    @RequestMapping("/rss")
    public String list(Integer nodeId, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        return list(null, nodeId, request, response, modelMap);
    }

    @RequestMapping(Constants.SITE_PREFIX_PATH + "/rss")
    public String list(@PathVariable String siteNumber, Integer nodeId, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        siteResolver.resolveSite(siteNumber);
