...
public class AdController {
    ...
    public String list(@PathVariable Integer id, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        return list(null, id, request, response, modelMap);
    }

    @RequestMapping(Constants.SITE_PREFIX_PATH + "/dd/{id}")
    public String list(@PathVariable String siteNumber, @PathVariable Integer id, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
    ...
    public String list(@PathVariable String number, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        return list(null, number, request, response, modelMap);
    }

    @RequestMapping(Constants.SITE_PREFIX_PATH + "/dd_number/{number}")
    public String list(@PathVariable String siteNumber, @PathVariable String number, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        siteResolver.resolveSite(siteNumber);
        Response resp = new Response(request, response, modelMap);
        List<String> messages = resp.getMessages();
    ...
    private String list(AdSlot slot, HttpServletRequest request, HttpServletResponse response, org.springframework.ui.Model modelMap) {
        Site site = Context.getCurrentSite();
