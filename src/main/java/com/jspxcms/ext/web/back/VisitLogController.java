...
public class VisitLogController {
    ...
    public String trafficAnalysis(Date begin, Date end, String period, HttpServletRequest request, org.springframework.ui.Model modelMap) {
    ...
    public String sourceAnalysis(Date begin, Date end, String period, Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        if ("today".equals(period)) {
            // 今日
            end = DateTime.now().toDate();
        ...
        Page<Object[]> pagedList = service.sourceByTime(begin, endNext, siteId, pageable);
        List<Object[]> sourceList = service.sourceCount(begin, endNext, siteId, pagedList.getContent(), 9);
        modelMap.addAttribute("pagedList", pagedList);
    ...
    public String urlAnalysis(Date begin, Date end, String period, Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        if ("today".equals(period)) {
            // 今日
            end = DateTime.now().toDate();
        ...
        Page<Object[]> pagedList = service.urlByTime(begin, endNext, siteId, pageable);
        modelMap.addAttribute("pagedList", pagedList);
        modelMap.addAttribute("period", period);
        modelMap.addAttribute("begin", begin);
        modelMap.addAttribute("end", end);
    ...
    public String countryAnalysis(Date begin, Date end, String period, Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        if ("today".equals(period)) {
            // 今日
            end = DateTime.now().toDate();
    ...
    public String browserAnalysis(Date begin, Date end, String period, Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        if ("today".equals(period)) {
            // 今日
            end = DateTime.now().toDate();
    ...
    public String osAnalysis(Date begin, Date end, String period, Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        if ("today".equals(period)) {
            // 今日
            end = DateTime.now().toDate();
    ...
    public String deviceAnalysis(Date begin, Date end, String period, Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
        Integer siteId = Context.getCurrentSiteId();
        if ("today".equals(period)) {
            // 今日
            end = DateTime.now().toDate();
