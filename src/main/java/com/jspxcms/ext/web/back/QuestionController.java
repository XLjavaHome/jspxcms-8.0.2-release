...
public class QuestionController {
    ...
    public String list(@PageableDefault(sort = {"creationDate", "id"}, direction = Direction.DESC) Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
    ...
    public String edit(Integer id, Integer position, @PageableDefault(sort = {"creationDate", "id"}, direction = Direction.DESC) Pageable pageable, HttpServletRequest request, org.springframework.ui.Model modelMap) {
        Site site = Context.getCurrentSite();
        Question bean = service.get(id);
        Backends.validateDataInSite(bean, site.getId());
        Map<String, String[]> params = Servlets.getParamValuesMap(request, Constants.SEARCH_PREFIX);
    ...
    public String save(Question bean, String[] itemTitle, Boolean[] itemEssay, String redirect, HttpServletRequest request, RedirectAttributes ra) {
    ...
    public String update(@ModelAttribute("bean") Question bean, Integer[] itemId, String[] itemTitle, Boolean[] itemEssay, Integer position, String redirect, HttpServletRequest request, RedirectAttributes ra) {
        Site site = Context.getCurrentSite();
        Backends.validateDataInSite(bean, site.getId());
