...
public abstract class AbstractGuestbookListPageDirective {
    ...
    public void doExecute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body, boolean isPage) throws TemplateException, IOException {
        ...
        if (isPage) {
            ...
            Page<Guestbook> pagedList = service.findPage(siteId, type, typeId, isRecommend, isReply, status, pageable);
            ...
            List<Guestbook> list = service.findList(siteId, type, typeId, isRecommend, isReply, status, limitable);
