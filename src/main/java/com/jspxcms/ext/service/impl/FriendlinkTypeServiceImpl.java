...
public class FriendlinkTypeServiceImpl implements FriendlinkTypeService, SiteDeleteListener {
    ...
    public void setDeleteListeners(List<FriendlinkTypeDeleteListener> deleteListeners) {
