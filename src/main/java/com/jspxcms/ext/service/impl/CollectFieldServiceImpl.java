...
public class CollectFieldServiceImpl implements CollectFieldService {
    ...
    @Transactional
    public List<CollectField> save(String[] code, String[] name, Integer[] type, Integer collectId, Integer siteId) {
    ...
    @Transactional
    public CollectField save(CollectField bean, Integer collectId, Integer siteId) {
    ...
    @Transactional
    public List<CollectField> update(Integer[] id, Integer[] sourceType, String[] sourceText, String[] sourceUrl, String[] dataPattern, Boolean[] dataReg, String[] dataAreaPattern, Boolean[] dataAreaReg, String[] filter, String[] downloadType, String[] imageParam, String[] dateFormat) {
        List<CollectField> list = new ArrayList<CollectField>();
