...
public class GuestbookTypeServiceImpl implements GuestbookTypeService, SiteDeleteListener {
    ...
    @Transactional
    public GuestbookType[] batchUpdate(Integer[] id, String[] name, String[] number, String[] description) {
    ...
    public void setDeleteListeners(List<GuestbookTypeDeleteListener> deleteListeners) {
