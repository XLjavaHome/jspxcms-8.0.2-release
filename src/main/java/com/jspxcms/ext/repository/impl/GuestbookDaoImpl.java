...
public class GuestbookDaoImpl implements GuestbookDaoPlus {
    public List<Guestbook> findList(Integer[] siteId, String[] type, Integer[] typeId, Boolean isRecommend, Boolean isReply, Integer[] status, Limitable limitable) {
        ...
        predicate(query, guestbook, siteId, type, typeId, isRecommend, isReply, status);
    ...
    private void predicate(JPAQuery<Guestbook> query, QGuestbook guestbook, Integer[] siteId, String[] type, Integer[] typeId, Boolean isRecommend, Boolean isReply, Integer[] status) {
