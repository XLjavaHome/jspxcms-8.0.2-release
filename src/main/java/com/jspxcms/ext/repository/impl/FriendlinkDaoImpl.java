...
public class FriendlinkDaoImpl implements FriendlinkDaoPlus {
    public List<Friendlink> findList(Integer[] siteId, String[] type, Integer[] typeId, Boolean isWithLogo, Boolean isRecommend, Integer[] status, Limitable limitable) {
        ...
        predicate(query, friendlink, siteId, type, typeId, isWithLogo, isRecommend, status);
        return QuerydslUtils.list(query, friendlink, limitable);
    }

    private void predicate(JPAQuery<Friendlink> query, QFriendlink friendlink, Integer[] siteId, String[] type, Integer[] typeId, Boolean isWithLogo, Boolean isRecommend, Integer[] status) {
