...
public interface QuestionRecordDao extends Repository<QuestionRecord, Integer>, QuestionRecordDaoPlus {
    public Page<QuestionRecord> findAll(Specification<QuestionRecord> spec, Pageable pageable);

    public List<QuestionRecord> findAll(Specification<QuestionRecord> spec, Limitable limitable);
    ...
    public long countByIp(Integer questionId, String ip, String cookie, Date after);
