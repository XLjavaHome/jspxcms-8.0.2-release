...
public interface CollectDao extends Repository<Collect, Integer>, CollectDaoPlus {
    public Page<Collect> findAll(Specification<Collect> spec, Pageable pageable);

    public List<Collect> findAll(Specification<Collect> spec, Limitable limitable);
